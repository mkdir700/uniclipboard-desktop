...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-20 md:w-64 bg-gray-900 border-r border-gray-800/50">
        ...
        <nav className="mt-8 flex-1">
          <div className="px-3 space-y-1">
            ...
            >
              ...
              <span className="hidden md:block">仪表板</span>
            </Link>
            ...
            >
              ...
              <span className="hidden md:block">历史记录</span>
            </Link>
            ...
            >
              ...
              <span className="hidden md:block">设备管理</span>
            </Link>
