      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <div className="flex items-center justify-between gap-4 py-2">
            ...
            <Select value={autoClearHistory} onValueChange={handleAutoClearHistoryChange}>
        ...
        <CardContent className="pt-0">
          <div className="space-y-2 py-2">
            ...
            <div className="flex justify-between text-xs text-muted-foreground">
              <span>
                {t('settings.sections.storage.storageUsage.usage', { percentage: '12.8' })}
              </span>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <div className="flex items-center gap-4 mb-4 px-6 pt-6">
          ...
          <span className="text-sm text-muted-foreground">
            {t('settings.sections.storage.historyRetention.days', { days: historyRetentionDays })}
          </span>
          <div className="h-px flex-1 bg-border/50"></div>
        </div>
        <CardContent className="pt-0">
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <div className="flex items-center justify-between gap-4 py-2">
            ...
            <Select value={maxHistoryItems.toString()} onValueChange={handleMaxHistoryItemsChange}>
              <SelectTrigger className="w-36">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
