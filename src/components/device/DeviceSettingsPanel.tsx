            ...
            {activeTab === 'rules' ? (
              ...
              >
                ...
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center justify-between bg-background/50 rounded-lg p-3 border border-border/30"
                  >
                    <div>
              ...
              >
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">控制该设备可以访问的内容类型。</p>
                </div>
